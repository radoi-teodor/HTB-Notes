```bash
nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -oN "/home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/_quick_tcp_nmap.txt" -oX "/home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/xml/_quick_tcp_nmap.xml" 10.129.103.141
```

[/home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/_quick_tcp_nmap.txt](file:///home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/_quick_tcp_nmap.txt):

```
# Nmap 7.94 scan initiated Sun Sep 10 05:58:45 2023 as: nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -oN /home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/_quick_tcp_nmap.txt -oX /home/kali/Documents/HTB/HTB-Notes/Pilgrimage/recon_scan/10.129.103.141/scans/xml/_quick_tcp_nmap.xml 10.129.103.141
adjust_timeouts2: packet supposedly had rtt of -699307 microseconds.  Ignoring time.
adjust_timeouts2: packet supposedly had rtt of -699307 microseconds.  Ignoring time.
adjust_timeouts2: packet supposedly had rtt of -696347 microseconds.  Ignoring time.
adjust_timeouts2: packet supposedly had rtt of -696347 microseconds.  Ignoring time.
Nmap scan report for 10.129.103.141
Host is up, received user-set (0.061s latency).
Scanned at 2023-09-10 05:58:46 EDT for 18s
...
TCP/IP fingerprint:
OS:SCAN(V=7.94%E=4%D=9/10%OT=22%CT=1%CU=41304%PV=Y%DS=2%DC=T%G=Y%TM=64FD936
OS:8%P=x86_64-pc-linux-gnu)SEQ(SP=107%GCD=1%ISR=10A%TI=Z%CI=Z%TS=A)OPS(O1=M
...
OS:DF=Y%TG=40%W=FAF0%O=M53CNNSNW7%CC=Y%Q=)ECN(R=Y%DF=Y%T=40%W=FAF0%O=M53CNN
...
OS:R%O=%RD=0%Q=)T5(R=Y%DF=Y%TG=40%W=0%S=Z%A=S+%F=AR%O=%RD=0%Q=)T5(R=Y%DF=Y%
OS:T=40%W=0%S=Z%A=S+%F=AR%O=%RD=0%Q=)T6(R=Y%DF=Y%TG=40%W=0%S=A%A=Z%F=R%O=%R
OS:D=0%Q=)T6(R=Y%DF=Y%T=40%W=0%S=A%A=Z%F=R%O=%RD=0%Q=)T7(R=N)U1(R=N)U1(R=Y%
OS:DF=N%T=40%IPL=164%UN=0%RIPL=G%RID=G%RIPCK=G%RUCK=G%RUD=G)IE(R=Y%DFI=N%TG
OS:=40%CD=S)IE(R=Y%DFI=N%T=40%CD=S)

Uptime guess: 28.665 days (since Sat Aug 12 14:01:00 2023)
...
HOP RTT      ADDRESS
1   60.67 ms 10.10.14.1
2   62.00 ms 10.129.103.141

Read data files from: /usr/bin/../share/nmap
OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Sun Sep 10 05:59:04 2023 -- 1 IP address (1 host up) scanned in 19.20 seconds
